...
const poemTiengViet2Tap1: Poem[] = [
  ...
  createPoem({
    ...
    textbook: "Tiếng Việt 2 - Tập 1",
    volume: "Tập 1",
    source: "Theo Thanh Hào.",
    addedAt: "2026-09-11",
  }),
  createPoem({
    slug: "co-giao-lop-em-tieng-viet-2",
    title: "Cô giáo lớp em",
    authorSlug: "nguyen-xuan-sanh",
    content:
      'Sáng nào em đến lớp\n\nCũng thấy cô đến rồi\n\nĐáp lời "Chào cô ạ!"\n\nCô mỉm cười thật tươi.\n\nCô dạy em tập viết\n\nGió đưa thoảng hương nhài\n\nNắng ghé vào cửa lớp\n\nXem chúng em học bài.\n\nNhững lời cô giáo giảng\n\nẤm trang vở thơm tho\n\nYêu thương em ngắm mãi\n\nNhững điểm mười cô cho.',
  ...
  createPoem({
    ...
    content:
      'Ông bị đau chân\nNó sưng nó tấy\nĐi phải chống gậy.\nViệt chơi ngoài sân\nLon ton lại gần:\n- Ông vịn vai cháu\nCháu đỡ ông lên.\n\nÔng bước lên thềm:\n- Hoan hô thằng bé!\nBé thế mà khoẻ\nVì nó thương ông.\n\nĐôi mắt sáng trong\nViệt ta thủ thỉ:\n- Khi nào ông đau\nÔng nói mấy câu\n"Không đau! Không đau!"\nDù đau đến đâu\nKhỏi ngay lập tức.\n\nÔng phải phì cười:\n- Ừ, ông theo lời\nThử xem có nghiệm:\n"Không đau! Không đau!"\nVà ông gật đầu:\n- Khỏi rồi! Tài nhỉ!\n\nViệt ta thích chí:\n- Cháu đã bảo mà...!\nVà móc túi ra:\n- Biếu ông cái kẹo!',
    excerpt:
      "Bài thơ thiếu nhi ấm áp về tình thương ông cháu, phù hợp với mạch đọc lớp 2 về gia đình và sự hồn nhiên chăm sóc người thân.",
    tags: [
      "tieng-viet-2-tap-1",
      "tho",
      "gia-dinh",
    ...
    textbook: "Tiếng Việt 2 - Tập 1",
    volume: "Tập 1",
    source: "Theo Tú Mỡ. (Mạnh Hưởng dịch).",
    addedAt: "2026-09-11",
  }),
  createPoem({
    slug: "ong-va-chau",
    ...
    excerpt:
      "Bài thơ ngắn và ấm áp về tình cảm ông cháu, phù hợp với mạch đọc lớp 2 về gia đình và sự lớn lên hồn nhiên của trẻ nhỏ.",
    tags: [
      "tieng-viet-2-tap-1",
      "tho",
      "gia-dinh",
    ...
    textbook: "Tiếng Việt 2 - Tập 1",
    volume: "Tập 1",
    source: "Theo Phạm Cúc.",
    addedAt: "2026-09-11",
  }),
  createPoem({
    slug: "me",
    title: "Mẹ",
    authorSlug: "tran-quoc-minh",
    content:
      "Lặng rồi cả tiếng con ve\nCon ve cũng mệt vì hè nắng oi.\nNhà em vẫn tiếng ạ ời\nKẽo cà tiếng võng mẹ ngồi mẹ ru.\n\nLời ru có gió mùa thu\nBàn tay mẹ quạt mẹ đưa gió về.\nNhững ngôi sao thức ngoài kia\nChẳng bằng mẹ đã thức vì chúng con.\n\nĐêm nay con ngủ giấc tròn\nMẹ là ngọn gió của con suốt đời.",
    excerpt:
      "Bài thơ dịu và sâu về mẹ, lời ru và sự thức khuya vì con, phù hợp với mạch đọc lớp 2 về tình cảm gia đình.",
    tags: [
      "tieng-viet-2-tap-1",
      "tho",
      "gia-dinh",
